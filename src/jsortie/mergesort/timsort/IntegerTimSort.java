...
/* The following is merely a copy of the source code in...
 * http://cr.openjdk.java.net/~martin/webrevs/openjdk7/timsort/raw_files/new/src/share/classes/java/util/TimSort.java
 * with the <T>s removed so it just sorts arrays of int.
 */
package jsortie.mergesort.timsort;

public class IntegerTimSort 
{
    ...
    public static void sort(int[] a, int lo, int hi) {
         ...
         */
        IntegerTimSort ts = new IntegerTimSort(a);
