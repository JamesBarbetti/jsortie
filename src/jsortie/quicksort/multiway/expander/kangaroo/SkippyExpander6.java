...
public class SkippyExpander6 
  extends HolierThanThouExpanderBase {
  public SkippyExpander6() {
    super(6, new SkippyExpander());
  }
  @Override
  public int[] expandPartitionsToLeft
    ...
    return new int[] 
      ...
      , hole3, hole3+1, hole4, hole4+1
      , hole5, hole5+1, hole6, hole6+1, stop };
  }
  @Override
