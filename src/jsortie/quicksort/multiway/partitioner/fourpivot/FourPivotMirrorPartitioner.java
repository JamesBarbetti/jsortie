...
public class FourPivotMirrorPartitioner 
  ...
  public int[] multiPartitionRange
    ...
    MultiPivotUtils.movePivotsAside
      ( vArray, pivotIndices, new int[] { start, start+1, stop-2, stop-1 } );
    int v1 = vArray[start];
    int v2 = vArray[start+1];
    int v3 = vArray[stop-2];
    ...
    ++b4;
    ++b5;
    return helper.fudgeBoundaries( vArray
      , new int[] 
        { start, b2, b2, b3, b3, b4
        , b4, b5, b5, stop } );		
  }
}
